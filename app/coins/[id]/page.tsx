...
import { formatCurrencyShrt } from "@/lib/utils";
...
export default async function page({ params }: NextPageProps) {
  ...
  const CoinDetails = [
    {
      label: "Market Cap",
      value: formatCurrencyShrt(coinData.market_data.market_cap.usd)
    },
    {
    ...
    {
      label: "Total Volume",
      value: formatCurrencyShrt(coinData.market_data.total_volume.usd)
    },
    {
      label: "Website",
      value: "-",
